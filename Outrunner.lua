...
return {
	{
		goods = {
			...
			items = {
				...
				-- случ. пермо-вард-эффект / пермо-вард
				{ id = rnd(pw4e(),pw6()), min = 1, max = 1 },
...
--				orr(orr({ id = 'g000ig9128', min = 1, max = 1}, { id = 'g001ig0259', min = 1, max = 1}), orr({ id = 'g001ig0063', min = 1, max = 1}, { id = 'g000ig9116', min = 1, max = 1})), -- Талисман Молнии 800 / Талисман призыва нейтралов III 600 / Талисман Прилива 800 / Талисман Святой земли 800
		...
		goods = {
			...
			items = {
				...
				-- случ. пермо-вард-дот / пермо-вард
...
artZone34 = {artctrl01(),'g000ig3004','g000ig2004','g001ig0124','g000ig3019','g001ig0612','g001ig0413','g001ig0415','g001ig0590','g001ig0060','g001ig0603','g001ig0657','g002ig0013','g001ig0592','g001ig0174','g002ig0011'}
...
orbZone34 = {orbctrl01(),'g000ig9020','g001ig0443','g000ig9021','g000ig9016','g001ig0203','g001ig0466','g001ig0480','g001ig0455','g001ig0489','g001ig0131'}
...
return {
	{
		goods = {
			...
			items = {
				...
				-- случ. пермо-вард-контроль / пермо-вард
				{ id = rnd(pw8(),pw6()), min = 1, max = 1 },
...
artZone5 = {artctrl02(),'g001ig0411','g001ig0604','g001ig0585','g001ig0046','g001ig0410','g001ig0102','g000ig2005','g000ig9035','g002ig0017','g001ig0488','g001ig0102','g002ig0014','g002ig0010'}
...
orbZone5 = {'g000ig9025','g000ig9014','g001ig0136','g001ig0457','g000ig9028','g001ig0183','g001ig0303','g001ig0059','g001ig0459','g001ig0477','g000ig9027','g000ig9032','g001ig0462'}
		...
		stack = {
			...
			loot = {
				items = {
					...
					{ id = rnd('g000ig0002','g002ig0007','g000ig0008','g001ig0125','g001ig0036','g001ig0036'), min = 1, max = 1 }, --защита15 / Зелье магической устойчивости / точность15 / вард разума / вард смерти / вард смерти
...
--				itemValue = { min = 710, max = 840 },
				items = {
					...
					{ id = rnd('g001ig0128',e4()), min = 1, max = 1 }, -- вард оружия/e4
		...
		stack = {
			...
			loot = {
				items = {
					...
					{ id = rnd('g000ig0018',rnd(pw6(),pw8()),rms()), min = 1, max = 1 }, -- хил200/пермовард/случ.шар манны
				}
			}
		}
	}
...
return {
	{
		...
		loot = {
			items = {
				-- Кровавый покров (Реликвия) / Латы Спасителя (Реликвия) / Лютня Очарования (Реликвия) / Нагрудник Стража (Реликвия) / Промасленная кольчуга (Реликвия) / Дьявольская чаша (Артефакт) / Кинжал Вампиризма (Артефакт) / Оковы долга (Реликвия)
				{id = rnd('g001ig0422','g001ig0423','g000ig3022','g001ig0427','g002ig0002','g000ig3002','g000ig3017','g001ig0610'), min = 1, max = 1},
			},
...
return {
	...
	loot = {
		...
		items = {
			...
			{ id = rnd(spherew(),orb400RespZ[2],orbResp1[5],orbResp2[5],'g001ig0164','g001ig0253','g001ig0255','g001ig0256','g000ig5050','g001ig0254','g000ig5069','g000ig5049','g000ig5034','g001ig0568','g000ig5118'), min = 1, max = 1 },
			{ id = b15(), min = 1, max = 1 },
			{ id = w15(), min = 1, max = 1 },
			{ id = e4(), min = 1, max = 1 }, --
		}
...
return {
	...
	loot = {
		items = {
			...
			{ id = 'g001ig0195', min = 1, max = 1 }, -- Свиток Откровение				
		}
	}
}
end
...
-- Лут в сундуках мини зон
function lootmini(mimirnd)
...
-- случайный пермо-вард-контроль за 800-900
function pw8()
	local radn = math.random(0,4)
	if radn == 0 then
...
function ruinTrainers()
	local radn = math.random(0,5)
	if radn == 0 then
	return 'g001ig0025' -- Аура живучести +10оз аое 1200
	elseif radn == 1 then
...
return { -- 300*1
		...
		loot = {
			items = {
				...
				{ id = rnd('g001ig0125','g001ig0036','g001ig0036'), min = 1, max = 1 }, --разума/смерти
...
return { -- 600xp*3
	...
	loot = {
		items = {
			...
			orr({ id = 'g000ig0022', min = 1, max = 1 }, { id = 'g000ig0023', min = 1, max = 1 }), --воды/земли
			orr({ id = 'g000ig0021', min = 1, max = 1 }, { id = 'g000ig0024', min = 1, max = 1 }), --возд/огня
			orr({ id = b15(), min = 1, max = 1}, { id = rnd('g002ig0005','g001ig0125','g001ig0036'), min = 1, max = 1}), -- случ. банка15 / Зелье набл.-15воры|вард разума|вард смерти
...
function getPlayerZone0(zoneId, playerRace, zoneSize)
	...
	return {
		...
		stacks = {Pred1RespZ0(), Pred1RespZ01(), Pred1RespZ02(), Pred1RespZ03(), Pred1RespZ04(), Pred1RespZD(), PredSkin(210, 220, 200, 225), PredBarb(220,230,0,0)},
...
--		resourceMarkets = rMarketsZone2(),
		stacks = {zoneStacksResp(), zoneStacksResp1(), Pred1Resp01(), Pred1Resp1(), Pred1Resp2(), Pred1Resp3(), Pred1Resp4(), Pred1Resp5(), Pred1RespD(), PredSkin(390, 400, 200, 250), PredBarb(480,484,200,200)},
		bags = bagsResp(),
	}
end
...
function getTreasureZone34(zoneId, playerRace, zoneSizeTre)
	return {
		...
		stacks = {zoneStacksZone34(), Pred1Zone1(), Pred1Zone2(), Pred1Zone3(), Pred1Zone4(), Pred1ZoneD(), PredBarb(770,774,400,400) },
		bags = bagsZone34(),
	}
end
...
function getTreasureZone5(zoneId, playerRace, playerRace2, zoneSizeTre)
	...
	id = zoneId,
		...
		stacks = {zoneStacksZone5(), zoneStacksZone501(), zoneStacksZone502(), zoneStacksZone503(), Pred1Zone51(), Pred1Zone52(), Pred1Zone53(), Pred1Zone54(), Pred1Zone5D(), PredBarb(1550,1600,500,550) },
		bags = bagsZone5(),
...
function getZones(races)
	...
	local z26 = 9 -- т2 90
	local z35 = 8 -- т3 82
	local z4 = 12 -- центр 120 /G/ 110 = gmm(12,11)
	local zh = 2.4
	...
	-- МИНИ ЗОНЫ
	-- перемешать таблицы для минизон
	mix(mni)
	mix(mngmni)
		
	if smode == 2 then
		zones[12] = getHostZone(13, races[3], zh)
		-- удаление первой записи из таблицы для миинзон
		table.remove(mni, 1)
