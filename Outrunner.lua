...
local goldr24 = {'g000uu5120','g000uu7593','g000uu8195','g000uu7500','g000uu5370','g000uu5123','g000uu8167'}

-- Лидеры для ГО-34
-- Ангел Перерожденный жж 1350, Бомбарда жо 1250, Желтый дракон з 1440, Костяной голем з 1195, Красный дракон о 1350, Синий дракон вд 1210, Тиамат о/р 900 + Белый дракон в 1160
local goldr34 = {'g000uu7503','g000uu8149','g000uu8198','g000uu7520','g000uu5119','g000uu5121','g000uu5368','g000uu5120'}
...
return {
	{
		goods = {
			...
			items = {
				...
				{ id = rnd('g001ig0562','g001ig0127'), min = 1, max = 1 }, -- Зелье дуэлянта +20крит / Эликсир жизненной силы +50максоз
		...
		goods = {
			...
			items = {
				...
				{ id = d15(), min = 1, max = 1}, -- случ. дотвард
				{ id = rnd('g002ig0005','g001ig0490','g002ig0007'), min = 1, max = 1 }, -- Зелье наблюдательности / Эликсир возвышения 250 +10бафы / Зелье магической устойчивости 
				{ id = rnd('g001ig0491','g002ig0008'), min = 1, max = 1 }, -- Зелье похищения жизни +25вамп / Эликсир скрытого потенциала 350 (+12точ.вт.атаки)
...
return {
	{
		goods = {
			...
			items = {
				...
				{ id = rnd('g001ig0355',e4()), min = 1, max = 1 }, -- Зелье тритоньей чешуи +вардурон / 
		...
		stack = {
			...
			loot = {
				items = {
					...
					{ id = rnd('g001ig0128',e4(),'g001ig0355'), min = 1, max = 1 }, -- вард оружия/e4/вардурон
...
return {
	...
	loot = {
		...
		items = {
			{ id = rnd('g000ig0001','g000ig0006','g000ig0006','g000ig0006'), min = 1, max = 1 }, --рес/хил100/хил100/хил100
			orr({ id = 'g001ig0180', min = 2, max = 2 }, { id = 'g000ig0005', min = 1, max = 1 }), --2трава/хил50
...
return {
	...
	loot = {
		...
		items = {
			{ id = rnd('g000ig0001','g000ig0006','g000ig0006'), min = 1, max = 1 }, --рес/хил100
...
return { --350xp*1 -- талисман 200-275
	...
	loot = {
		items = {
			{ id = rnd('g000ig0001','g001ig0378'), min = 1, max = 1 }, --рес/хил75
			{ id = rndy(ttal2), min = 1, max = 1}, -- талик т2
			orr({ id = 'g000ig0021', min = 1, max = 1 }, { id = 'g000ig0024', min = 1, max = 1 }), --возд/огня
		}
	}
...
function Pred1ZoneD()
return { --1200хп*1 --свиток т3 + пермо
	count = 1,
	subraceTypes = NoUndead(),
...
return { -- точн30 / сл.банка30 + 25вамп 
	count = 1,
	subraceTypes = NoUndead(),
...
return { -- сл.банка30 + эл. защ. от аффекта / эл. скрыт. потенциала
	count = 1,
	subraceTypes = NoUndead(),
...
return {
	...
	value = { min = 1350*kef, max = 1420*kef }, 
	leaderIds = goldr24,
	-- сопротивляемость ворам -10
	leaderModifiers = {'g201um9131'},
