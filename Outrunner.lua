...
-- переменные для предмтов на опыт в лавках т2 (2 предмета из 3 цифр = 66% шанс)
local t2var = {0,1,2}

-- переменные для предмтов на опыт в лавке т3 (2 предмета из 3 цифр = 66% шанс)
local t3var = {0,1,2}

-- переменная для имени лидера ГО по бенке на перк
local nldr = '';
------
...
-- (не использую) Свитки на статы т3: Preces -15точ-15урон, Гимн кланов +12ини, Неотвратимая месть +15крит, Отвлечение -15точн-15урон, Святая броня +12броня, Святая сила +15точн+15урон
local Scrollst3 = {'g000ig5089','g000ig5026','g001ig0572','g000ig5111','g000ig5012','g000ig5013'}

-- Свитки на статы т4: Tempus status -27ини, Tortio menta-30точн, Благословение Вотана +25урон, Гниение -30 урон, Призыв к оружию +25урон, Проклятие Галеана -30урон, Стойкость +22броня, Ужас -27ини
local Scrollst4 = {'g000ig5091','g000ig5055','g000ig5036','g000ig5076','g000ig5017','g000ig5115','g000ig5035','g000ig5075'}

-- 100 Сферы т1 в цель: Камня, Костра, Ледяного осколка, Статического разряда, Чумы
local torb11 = {'g001ig0189', 'g001ig0178', 'g001ig0472', 'g001ig0473', 'g000ig9033'} 
...
-- Для лавки т0 и т1
--сферы 200x6: Сфера Брони I +15брони-1 200, Вампиризма I +20вамп-1 200, Восстановления 30хил-аое 200, Охотника 40урона-1 200, Разрушения доспеха I -15брони-1 200, Урона I +20урон-1 200
...
--			itemValue = { min = 200, max = 200 },
			items = {
				...
				-- Зелье дозорного (+1 обзор)/Зелье ясного взора (+2 обзора) / Эликсир маскировки 400 / Аура жизненной силы 10оз_отряду
				{ id = rnd(rnd('g001ig0532', 'g001ig0533'), 'g001ig0006','g001ig0034'), min = 1, max = 1 },
				-- банка на талики / реген / точность
				{ id = rndy(tp0p), min = 1, max = 1 },

				-- случ.пермо-вард-эффект 400 
				{ id = rnd(pw4e()), min = 1, max = 1 },
				...
				--сферы 100
				{ id = 'g001ig0192', min = 1, max = 1 }, -- Сфера пыток 50 разум
...
artRespZ = {'g002ig0001','g001ig0418','g000ig2002','g001ig0182','g001ig0048'}
...
relRespZ = {'g001ig0497','g000ig4006','g001ig0421','g001ig0428','g001ig0099','g000ig4007',rnd('g000ig4001','g000ig4002','g000ig4003','g000ig4004')}

--знамёна 6x400+500: защиты, выносл, силы, сражения
flagRespZ = {'g000ig1001','g001ig0051','g000ig1007','g000ig1003'}

--сферы 400x5: Сфера Молнии 80 400, Сфера Пламени 80урон 400, Сфера Святой земли 60хил-ряду 400, Сфера Вампиризма II 40-1 400, Сфера очищения 400
orb400RespZ = {'g001ig0300','g001ig0187','g001ig0453','g001ig0176','g001ig0157'}
...
--			itemValue = { min = 200, max = 200 },
			items = {
				...
				{ id = rnd('g001ig0125','g001ig0036','g001ig0036'), min = 1, max = 1 }, -- вард разума/вард смерти
				...
				-- случ.пермо-вард-эффект 400 / случ.пермо-вард-дот 400
				{ id = rnd(pw4e(),pw4d()), min = 1, max = 1 },
...
--для первой лавки
--арты 800-1000x12: д.чаша, рун.жизн800, прокл.пепел950, Кольцо темных искуств800, Рог возмездия, Руна верности, кров.свят, кол.силы, Щит телохранителя, серд.эмира, Эльфийская брошь
artResp1 = {'g000ig3002','g001ig0047','g001ig0197','g001ig0487','g001ig0558','g001ig0417','g001ig0045','g000ig3003','g001ig0594','g000ig9137','g001ig0071'}

--релики 600-800x6: зуб людоеда, лютня650, Вечные латы, Кровавый покров, Шлем проклятого, Оковы долга
relResp1 = {'g001ig0104','g000ig3022','g001ig0420','g001ig0422','g001ig0037','g001ig0610'}

--знамёна 600-800x5: гор.стр700, разум700,энерг700,искоренителя ереси600, главаря наемников800, быстроты550
flagResp1 = {'g001ig0289','g001ig0145','g000ig1008','g001ig0370','g002ig0003','g000ig1005'}

--сферы 400-500x11: Прилива 80, Мучений 80, направленного ослабления I -33урон-1, Обширной коррозии I-10броня-аое, Прорицательницы 55хил аое, Урона II +40урон-1, Переохлаждения 40мороз непр., Бури 66 2x2, защиты от магии Смерти, Жажды 45вамп, Сфера очищения 400
orbResp1 = {'g001ig0456','g001ig0496','g000ig9042','g001ig0475','g000ig9018','g001ig0134','g001ig0478','g001ig0467','g001ig0057','g000ig9024','g001ig0157'}
...
artResp2 = {'g000ig3017','g001ig0040','g001ig0155','g001ig0196','g001ig0582','g001ig0559','g001ig0557','g001ig0416','g001ig0589','g000ig2003','g001ig0591','g001ig0041'}

--релики 650-800x6: таира чистоты, череп танатоса, Латы Спасителя, Роба убийцы, Промасленная кольчуга, Нагрудник Стража
relResp2 = {'g000ig2006','g000ig3020','g001ig0423','g001ig0430','g002ig0002','g001ig0427'}

--знамёна 700x: бан.неуд700, стяг.конц, горна, ража, неистовства, магии Воды, Воздуха, Земли, Огня
flagResp2 = {'g001ig0293','g001ig0292','g001ig0361','g001ig0358','g001ig0357',rnd('g001ig0142','g001ig0140','g001ig0141','g001ig0139')}

--сферы 400-500x11: Вампира70, Скалы 80урон-1, Массового ослабления I -33урон аое, Разрушения доспеха II -30брони-1, Помощи 75хил 2x2, Замедления 50-1, Пожара 55крест, Боли 60 ряд, защиты от магии Разума, Оползня 50урон 2колоны, Сфера очищения 400
orbResp2 = {'g001ig0191','g001ig0474','g001ig0461','g001ig0479','g001ig0454','g001ig0295','g001ig0469','g001ig0304','g001ig0468','g001ig0157'}
...
return {
	{
		goods = {
			...
			items = {
				...
				-- случ.пермо-вард-дот 400 / случ.пермо-вард 600
				{ id = rnd(pw4d(),pw6()), min = 1, max = 1 },
				...
				--сапоги
				{ id = rnd('g000ig8003','g001ig0111'), min = 1, max = 1 }, -- Сапоги скорости / Сапоги ассасина
		...
		goods = {
			...
			items = {
				...
				--сапоги
				{ id = rnd('g000ig1010','g001ig0114'), min = 1, max = 1 }, -- Эльфийские сапоги / Тяжелые сапоги
...
--арты 1000-1450x14,2400: арт-контроль: Клыки Бездны950, Ужасающий топор1200; рун.клин1200, рог.всев1200, клин.возв1200, Клинок Танатоса, Кольцо небесной воли, Корни триббога, Руна кары Тьяцци, Щит Мизраэля, Тысяча чешуек, Чаша жатвы, Топор палача, Серп Кровавого Ворона, Монолитный щит1200, Божественный потир1200, Щит рыцаря Феникса
artZone34 = {'g001ig0042','g001ig0158','g000ig3004','g000ig2004','g001ig0124','g000ig3019','g001ig0612','g001ig0413','g001ig0415','g001ig0590','g001ig0060','g001ig0603','g001ig0657','g002ig0013','g001ig0592','g001ig0174','g002ig0011'}
...
relZone34 = {'g000ig2006','g001ig0156','g000ig3022','g001ig0597','g001ig0539','g001ig0424','g001ig0602','g002ig0015'}
...
flagZone34 = {'g000ig1002','g000ig1006','g001ig0362','g001ig0364','g001ig0363','g001ig0374','g001ig0365','g001ig0375','g001ig0367','g001ig0360','g001ig0359'}

--сферы 600-700x9,800x2: Сфера Страха 800, Брони II 25 600, Вампиризма III 60 700, Великого исцеления 80 700, Массового ослабления II 50 700, Морской пучины 110урон 700, Горы урон110 800, Спасения 100хил 2колонны 700, Угнетения 110 урон 700, Урона III +урон60 700, Направленного ослабления II 50 700
orbZone34 = {'g001ig0181','g001ig0443','g000ig9021','g000ig9016','g001ig0203','g001ig0466','g001ig0480','g001ig0455','g001ig0489','g001ig0131','g001ig0462'}
...
return {
	{
		goods = {
			...
			items = {
				...
				-- Война престолов (-10 воры) 600 / Зелье удачи (5 крит) / Зелье загробных тайн (п.вард оружие) / Зелье рвения
				{ id = rnd('g001ig0519','g001ig0548','g001ig0324','g001ig0083'), min = 1, max = 1 },

				-- случ.пермо-вард 600 / случ.пермо-вард-спец 800-900
				{ id = rnd(pw6(),pw8()), min = 1, max = 1 },
...
--арты 12: арт-контроль: Кристалл души, Рог Инкуба, Клинок Сущего; Грань реальности, Кинжал жатвы, Кольцо создателя, Кровь Владыки, Дьявольская булава, Коготь Пожирателя, Гравированная диадема, Слеза Мортис, Копье Ангела, Кольцо Несгибаемого стража, Коготь Пожирателя, Кама Кровавого Ворона, Меч рыцаря Феникса
artZone5 = {'g000ig3015','g000ig3016','g000ig3018','g001ig0411','g001ig0604','g001ig0585','g001ig0046','g001ig0410','g001ig0102','g000ig2005','g000ig9035','g002ig0017','g001ig0488','g001ig0102','g002ig0014','g002ig0010'}

--релики 6: Шлем воителя, плас.досп, кор.имп, тяж.латы, кор.мьолн, Доспех рыцаря Феникса
relZone5 = {'g001ig0419','g001ig0116','g000ig7010','g001ig0038','g000ig3005','g002ig0012'}
...
flagZone5 = {'g001ig0142','g001ig0140','g001ig0141','g001ig0139','g001ig0145','g001ig0143','g002ig0016','g001ig0366','g001ig0373','g001ig0500'}

--сферы 700-1000x14: Алчности 60 вамп аое 900, Массового замедления 50 1000, Брони III 35 800, Испепеления 110урон 700, Грозы 110урон 700,Обширной коррозии II -20брони аое 700, Древнего вамп100 800, защиты от Оружия 800, Землетрясения 75 колонны 900, Терзаний 85 ряд 900, Урагана 99 2x2 900, цунами 90 неприкр 900
orbZone5 = {'g000ig9025','g000ig9014','g001ig0136','g001ig0457','g000ig9028','g001ig0183','g001ig0303','g001ig0059','g001ig0459','g001ig0477','g000ig9027','g000ig9032'}
...
return {
	{
		goods = {
			...
			items = {
				...
				-- случ.пермо-вард
				{ id = rnd(pw4d(),pw4e(),pw6(),pw8()), min = 1, max = 1 },
		...
		stack = {
			...
			loot = {
				items = {
					...
					{ id = rnd('g000ig0018',pw6(),pw8()), min = 1, max = 1 }, -- хил200/пермо-вард/пермо-вард-спец
				}
			}
		}
	}
	...
	},
	{
		...
		loot = {
			items = {
				...
				{id = rnd('g000ig2001','g001ig0611','g000ig3001','g001ig0100',rnd('g000ig3008','g000ig4008','g001ig0101')), min = 1, max = 1},
			},
...
return {
	...
	},
	{
		...
		loot = {
			items = {
				-- Знамя быстроты / Знамя выносливости / Знамя защиты / Знамя силы / Знамя сражения / Сапоги ассасина / Тяжелые сапоги 
...
return {
	{
		...
		loot = {
			items = {
				-- Кровавый покров (Реликвия) / Латы Спасителя (Реликвия) / Лютня Очарования (Реликвия) / Нагрудник Стража (Реликвия) / Промасленная кольчуга (Реликвия) / Дьявольская чаша (Артефакт) / Кинжал Вампиризма (Артефакт)
				{id = rnd('g001ig0422','g001ig0423','g000ig3022','g001ig0427','g002ig0002','g000ig3002','g000ig3017'), min = 1, max = 1},
			},
	...
	},
	{
		...
		loot = {
			items = {
				...
				-- / Стяг концентрации / Стяг чумных воинств
...
function getMinesZone5(race, race2)
	...
	{gold = 2, lifeMana = 1, runicMana = 1, deathMana = tblmid[1], infernalMana = tblmid[2], groveMana = tblmid[3]}

	elseif race == Race.Human and race2 == Race.Undead or race == Race.Undead and race2 == Race.Human then return
	{gold = 2, lifeMana = 1, deathMana = 1, runicMana = tblmid[1], infernalMana = tblmid[2], groveMana = tblmid[3]}

	elseif race == Race.Human and race2 == Race.Heretic or race == Race.Heretic and race2 == Race.Human then return
	{gold = 2, lifeMana = 1, infernalMana = 1, deathMana = tblmid[1], runicMana = tblmid[2], groveMana = tblmid[3]}

	elseif race == Race.Human and race2 == Race.Elf or race == Race.Elf and race2 == Race.Human then return
	{gold = 2, lifeMana = 1, groveMana = 1, deathMana = tblmid[1], infernalMana = tblmid[2], runicMana = tblmid[3]}

	elseif race == Race.Dwarf and race2 == Race.Undead or race == Race.Undead and race2 == Race.Dwarf then return
	{gold = 2, runicMana = 1, deathMana = 1, lifeMana = tblmid[1], infernalMana = tblmid[2], groveMana = tblmid[3]}

	elseif race == Race.Dwarf and race2 == Race.Heretic or race == Race.Heretic and race2 == Race.Dwarf then return
	{gold = 2, runicMana = 1, infernalMana = 1, deathMana = tblmid[1], lifeMana = tblmid[2], groveMana = tblmid[3]}

	elseif race == Race.Dwarf and race2 == Race.Elf or race == Race.Elf and race2 == Race.Dwarf then return
	{gold = 2, runicMana = 1, groveMana = 1, deathMana = tblmid[1], infernalMana = tblmid[2], lifeMana = tblmid[3]}

	elseif race == Race.Undead and race2 == Race.Heretic or race == Race.Heretic and race2 == Race.Undead then return
	{gold = 2, deathMana = 1, infernalMana = 1, lifeMana = tblmid[1], runicMana = tblmid[2], groveMana = tblmid[3]}

	elseif race == Race.Undead and race2 == Race.Elf or race == Race.Elf and race2 == Race.Undead then return
	{gold = 2, deathMana = 1, groveMana = 1, lifeMana = tblmid[1], infernalMana = tblmid[2], runicMana = tblmid[3]}

	elseif race == Race.Heretic and race2 == Race.Elf or race == Race.Elf and race2 == Race.Heretic then return
	{gold = 2, infernalMana = 1, groveMana = 1, deathMana = tblmid[1], lifeMana = tblmid[2], runicMana = tblmid[3]}
...
return {
	...
	loot = {
		...
		items = {
			...
			{ id = rnd(orb200RespZ[4],rnd('g000ig5043','g000ig5041','g000ig5024','g000ig5007','g000ig5097','g000ig5004','g000ig5062','g000ig5025','g000ig5061','g000ig5098','g000ig5063')), min = 1, max = 1 }, -- сфера 200 / свиток "Ignis mare", "Incantare Hellhound", буран, исцеление, кустарник, молния, мор, рух, скелет, энт, сн.буря
...
return {
	...
	loot = {
		...
		items = {
			...
			{ id = 'g000ig0006', min = 1, max = 1 }, --хил100
			{ id = 'g001ig0378', min = 1, max = 1 }, --хил75
			-- Сфера-вард / Сферы 400-500 
			{ id = rnd(spherew(),orb400RespZ[2],orbResp1[5],orbResp2[5]), min = 1, max = 1 },
			...
			{ id = e2(), min = 1, max = 1 },
			{ id = e4(), min = 1, max = 1 },
			{ id = ExtraHomeMana(playerRace), min = 1, max = 1 }, -- родной шар расы 1
			{ id = ExtraHomeMana(playerRace2), min = 1, max = 1 }, -- родной шар расы 2
			{ id = 'g001ig0524', min = 1, max = 1 }, -- Зелье завоевателя (желы)
		}
	}
}
end
...
-- случайный пермо-эликсир за 400-600 (разнобой)
function p04()
	local radn = math.random(0,4)
	if radn == 0 then
	return 'g001ig0034' -- Аура жизненной силы +10оз_отряду 400
	elseif radn == 1 then
	return 'g001ig0315' -- Зелье великана +5%оз 400
	elseif radn == 2 then
	return 'g001ig0006' -- Эликсир маскировки -50%озу 400
	elseif radn == 3 then
	return 'g001ig0519' -- Война престолов -10воры 600
	elseif radn == 4 then
	return 'g001ig0561' -- Эликсир самопожертвования -25телохранитель 600
	end
end


-- случайный пермо-эликсир за 400 (на 5%)
function p05()
	local radn = math.random(0,3)
	if radn == 0 then
...
-- случайный пермо-эликсир 10% + разное за 600-900 (для ГО к тренеру)
function p06()
	local radn = math.random(0,9)
	if radn == 0 then
	return 'g000ig0010' -- Эликсир внимательности 500
	elseif radn == 1 then
	return 'g000ig0016' -- Эликсир мощи 625
	elseif radn == 2 then
	return 'g000ig0013' -- Эликсир неуловимости 650
	elseif radn == 3 then
	return 'g000ig0004' -- Эликсир твердости 730
	elseif radn == 4 then
	return 'g001ig0083' -- Зелье рвения 500
	elseif radn == 5 then
	return 'g001ig0548' -- Зелье удачи (5 крит) 700
	elseif radn == 6 then
	return 'g001ig0324' -- Зелье загробных тайн (вард оружие) 900
	elseif radn == 7 then
	return 'g001ig0501' -- Дары Галлеана (Хождение по лесу) 750
	elseif radn == 8 then
	return 'g001ig0534' -- Экстракт таинственной энергии (Меняет источник атаки) 700
	elseif radn == 9 then
	return 'g001ig0521' -- Зелье разоблачения (-20 воры) 1000
	end
end
...
-- случайный пермо-вард-спец за 800-900
function pw8()
	local radn = math.random(0,5)
	if radn == 0 then
		return 'g001ig0325' -- Зелье здравомыслия (защита от разума) 900
		elseif radn == 1 then
		return 'g001ig0326' -- Зелье немертвых (защита от смерти) 900
		elseif radn == 2 then
		return 'g001ig0336' -- Эликсир павших оков (защита от окаменения) 800
		elseif radn == 3 then
		return 'g001ig0338' -- Эликсир непоколебимости (защита паралича) 800
		elseif radn == 4 then
		return 'g001ig0334' -- Эликсир безраздельности (иммунитет к имитации) 800
		elseif radn == 5 then
		return 'g001ig0340' -- Эликсир непорочности (защита от полиморфа) 800
	end
end
...
return { --300xp*1 / Зелье дозорного
	count = 1,
	subraceTypes = NoUndead(),
	value = { min = vgmode1(310), max = vgmode1(310)*kr },
	loot = {
		items = {
			{ id = rnd(e2(),'g001ig0532'), min = 1, max = 1 }, -- эл200/Зелье дозорного
			{ id = 'g001ig0378', min = 1, max = 1}, --хил75
			{ id = rmss(), min = 1, max = 1 }, --случ.мал.шар манны
		}
	}
...
return { -- 500хп*2 -- пермо
	...
	loot = {
		items = {
			{ id = rnd('g001ig0561','g001ig0533',pw4d(),pw4e()), min = 1, max = 1 }, -- Эликсир самопожертвования -телохр.25 / Зелье ясного взора 400 / Пермоварды-дот-эффект 400 / пермо-вард-эффект за 400
			{ id = 'g001ig0378', min = 1, max = 1}, --хил75
...
return { -- 900хп*2 -- элексир буст 350-425
	subraceTypes = rsub(),
	count = 1,
	value = { min = vgmode3(900), max = vgmode3(900)*kr },
	loot = {
		itemTypes = { Item.PotionBoost },
		value = { min = 340, max = 450 }, -- эликсир 350-425
		itemValue = { min = 340, max = 450 },
		items = {
			{ id = 'g000ig0006', min = 1, max = 1 }, --хил100
...
return {
	subraceTypes = { Subrace.NeutralDragon, Subrace.Human, Subrace.Heretic, Subrace.Dwarf, Subrace.Elf }, -- Subrace.Undead, убрал
	value = { min = 1550*kef, max = 1620*kef }, 
...
--		itemValue = { min = 400, max = 500 },
		items = {
			...
			{ id = e2(), min = 1, max = 1}, --
			{ id = rnd(p04(),pw4e(),pw4d()), min = 1, max = 1}, -- пермо400 разное / вард-эффект / вард-дот
...
--		itemValue = { min = 600, max = 800 },
		items = {
			...
			{ id = e4(), min = 1, max = 1 }, --
			{ id = rnd(p05(),pw6(),pw8()), min = 1, max = 1}, -- пермо400+600+800 5%статы / вард / вард_спец
			{ id = getperk, min = 1, max = 1}, --случ.банка на перк
		}
	}
}
...
return {
	subraceTypes = { Subrace.NeutralDragon, Subrace.Human, Subrace.Heretic, Subrace.Dwarf, Subrace.Elf }, -- Subrace.Undead, убрал
	value = { min = 2400*kef, max = 2500*kef },
	-- сопротивляемость ворам -10
	leaderModifiers = {'g201um9131'},
	loot = {
		items = {
			...
			{ id = e4(), min = 1, max = 1 }, --эликсир400
			{ id = p06(), min = 1, max = 1 }, --пермо 600-900
		}
	}
}
end
			...
			garrison = { -- столица
				...
				loot = {
					...
					items = {
						...
						{ id = rnd('g001ig0490','g001ig0128','g002ig0008'), min = 1, max = 1}, -- Зелье выносливости +15%оз / вард оружия / Эликсир скрытого потенциала 500 (20оз +7точ.вт.атаки)
...
function getTreasureZone5(zoneId, playerRace, playerRace2, zoneSizeTre)
	...
	id = zoneId,
		...
		stacks = {zoneStacksZone5a(), zoneStacksZone5b(), zoneStacksZone5c(), zoneStacksZone501(), zoneStacksZone502(), zoneStacksZone503(), Pred1Zone51(), Pred1Zone52(), Pred1Zone53(), Pred1Zone54(), Pred1Zone5D(), PredBarb(1550,1600,500,550) },
...
function getZones(races)
	...
	local z910 = 4 -- 4 -- тренер 50
	local z08 = 5 -- 5 -- т0 стольня 50
	local z17 = 6 -- 6 -- т1 60
	local z26 = 9 -- 9 -- т2 90
	local z35 = 8 -- 8 -- т3 82
	local z4 = 12 -- 12 -- центр 120 /G/ 110 = gmm(12,11)
	local zh = 2.4 -- 2.4 -- минизоны
	
	-- перемешать таблицу предметов на опыт для лавок т2
	mix(exp1)
	-- перемешать таблицу предметов на опыт для лавок т3 (50%)
	mix(exp2)
...
local connections = {
	...
	{from = 1, to = 0}, {from = 1, to = 0}, {from = 1, to = 0, guard = gmm('',zoneStacksP01())}, {from = 1, to = 0},
...
-- Параметры
	customParameters = {
		{
			name = 'Сила Нейтралы', -- parameters[2] -- kef
			unit = '%',
            min = 50,
            max = 200,
            step = 5,
