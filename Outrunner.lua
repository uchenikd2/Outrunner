...
--				orr({ id = 'g001ig0524', min = 1, max = 1 }, { id = 'g001ig0376', min = 1, max = 1 }), -- Зелье завоевателя (жезлы) / Эликсир обновления (+30 реген)
				...
				--сапоги
				{ id = rnd('g000ig8003','g001ig0111','g001ig0516'), min = 1, max = 1 }, -- Сапоги скорости / Сапоги ассасина / Зелье омоложения разума (-10 опыт)
...
return {
	...
	},
	{
		...
		loot = {
			items = {
				-- Знамя быстроты / Знамя выносливости / Знамя защиты / Знамя силы / Знамя сражения / Сапоги ассасина / Тяжелые сапоги / Знамя мастера 
				{id = rnd('g000ig1005','g001ig0051','g000ig1001','g000ig1007','g000ig1003','g001ig0111','g001ig0114','g001ig0587'), min = 1, max = 1},
			},
...
if mni[1] == 0 then
	tbagsMini.loot = {
		items = {
			-- Свитки на статы т4: Tempus status -27ини, Tortio menta-30точн, Благословение Вотана +25урон, Гниение -30 урон, Призыв к оружию +25урон, Проклятие Галеана -30урон, Стойкость +22броня, Ужас -27ини
			{ id = rnd('g000ig5091','g000ig5055','g000ig5036','g000ig5076','g000ig5017','g000ig5115','g000ig5035','g000ig5075'), min = 1, max = 1 }, -- Свиток т4 на статы
		}
	}
elseif mni[1] == 1 then
	tbagsMini.loot = {
...
return {
	...
	loot = {
		items = {
			{ id = Scrollst4, min = 1, max = 1 }, -- Свиток т4 на статы
		}
	}
}
end
...
function ruinTrainers2()
	...
	elseif radn == 5 then
	return 'g001ig0523' -- Зелье воеводы (аое опыт 10) 1000
...
function getZones(races)
	...
	-- МИНИ ЗОНЫ
	-- перемешать таблицу для минизон
	mix(mni)
